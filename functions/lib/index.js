...
function isHttpsError(err) {
    var _a;
    return err && typeof err === "object" && ((_a = err.constructor) === null || _a === void 0 ? void 0 : _a.name) === "HttpsError";
}
function safeErrorPayload(err) {
    var _a, _b, _c;
    return {
        originalCode: (_a = err === null || err === void 0 ? void 0 : err.code) !== null && _a !== void 0 ? _a : null,
        originalMessage: (_b = err === null || err === void 0 ? void 0 : err.message) !== null && _b !== void 0 ? _b : String(err),
        stack: (_c = err === null || err === void 0 ? void 0 : err.stack) !== null && _c !== void 0 ? _c : null,
    };
}
function wrapCallable(name, handler) {
    return onCall(async (request) => {
        var _a, _b;
        const uid = (_b = (_a = request.auth) === null || _a === void 0 ? void 0 : _a.uid) !== null && _b !== void 0 ? _b : null;
        ...
        try {
            ...
            try {
                ...
                logger.error(`[callable:${name}] failed to write error doc`, {
                    uid,
                    runId,
                    writeMessage: writeErr === null || writeErr === void 0 ? void 0 : writeErr.message,
                });
            }
            if (isHttpsError(err))
                throw err;
            throw new HttpsError("internal", (err === null || err === void 0 ? void 0 : err.message) || "internal", safeErrorPayload(err));
        }
    });
}
function requireCityId(envKey, taskName) {
    ...
    if (!cityId) {
        throw new Error(`${taskName} requires a city id. Set ${envKey} or CITY_ID/DEFAULT_CITY_ID.`);
    }
    return cityId;
}
...
exports.aggregateSegmentPassToCitySegments = onDocumentWritten("telemetrySegmentPasses/{docId}", async (event) => {
    var _a, _b, _c, _d, _e;
    const change = event.data;
    const afterSnap = change === null || change === void 0 ? void 0 : change.after;
    const docId = (afterSnap === null || afterSnap === void 0 ? void 0 : afterSnap.id) || ((_a = event.params) === null || _a === void 0 ? void 0 : _a.docId) || "unknown";
    ...
    try {
        ...
        after = afterSnap === null || afterSnap === void 0 ? void 0 : afterSnap.data();
        const baseRunPayload = {
            seenAt: admin.firestore.FieldValue.serverTimestamp(),
            docId,
            ...(typeof (after === null || after === void 0 ? void 0 : after.cityId) === "string" ? { cityId: after.cityId } : {}),
            ...(typeof (after === null || after === void 0 ? void 0 : after.h3) === "string" ? { h3: after.h3 } : {}),
        };
        ...
        await admin
            ...
            seenAt: admin.firestore.FieldValue.serverTimestamp(),
            docId,
            cityId: after === null || after === void 0 ? void 0 : after.cityId,
            h3: after === null || after === void 0 ? void 0 : after.h3,
            roughnessPercent: after === null || after === void 0 ? void 0 : after.roughnessPercent,
            afterExists: !!(afterSnap === null || afterSnap === void 0 ? void 0 : afterSnap.exists),
            afterCityId: after === null || after === void 0 ? void 0 : after.cityId,
            afterH3: after === null || after === void 0 ? void 0 : after.h3,
            afterRoughnessPercent: after === null || after === void 0 ? void 0 : after.roughnessPercent,
            afterSampleCount: after === null || after === void 0 ? void 0 : after.sampleCount,
            afterAggProcessed: after === null || after === void 0 ? void 0 : after._aggProcessed,
        }, { merge: true });
        if (!afterSnap || !afterSnap.exists) {
            await writeRunHeartbeat("skipped", { reason: "missing_after" });
            return;
        }
        if ((after === null || after === void 0 ? void 0 : after._aggProcessed) === true) {
            await admin
                .firestore()
        ...
        const missingFields = [];
        if (typeof (after === null || after === void 0 ? void 0 : after.cityId) !== "string")
            missingFields.push("cityId");
        if (typeof (after === null || after === void 0 ? void 0 : after.h3) !== "string")
            missingFields.push("h3");
        if (typeof (after === null || after === void 0 ? void 0 : after.roughnessPercent) !== "number" ||
        ...
        if (result && result.skipped !== true) {
            const cityIdValue = typeof result.cityId === "string"
                ? result.cityId
                : typeof (after === null || after === void 0 ? void 0 : after.cityId) === "string"
                    ? after.cityId
                    : null;
            const h3Value = typeof result.h3 === "string"
                ? result.h3
                : typeof (after === null || after === void 0 ? void 0 : after.h3) === "string"
                    ? after.h3
                    : null;
            if (cityIdValue) {
                await admin
                    ...
                    lastAggDocId: docId,
                    lastAggH3: h3Value,
                    lastAggRoughnessPercent: (_c = (_b = result.roughnessPercent) !== null && _b !== void 0 ? _b : after === null || after === void 0 ? void 0 : after.roughnessPercent) !== null && _c !== void 0 ? _c : null,
        ...
        await admin
            ...
            .doc(`aggDebug/segmentAgg/errors/${docId}`)
            .set({
            errorMessage: (error === null || error === void 0 ? void 0 : error.message) || "unknown_error",
            errorStack: (error === null || error === void 0 ? void 0 : error.stack) || null,
            failedAt: admin.firestore.FieldValue.serverTimestamp(),
            cityId: (_d = after === null || after === void 0 ? void 0 : after.cityId) !== null && _d !== void 0 ? _d : null,
            h3: (_e = after === null || after === void 0 ? void 0 : after.h3) !== null && _e !== void 0 ? _e : null,
        }, { merge: true });
        throw error;
    }
});
exports.segmentPassCanary = onDocumentCreated("telemetrySegmentPasses/{docId}", async (event) => {
    var _a;
    const snap = event.data;
    const docId = (snap === null || snap === void 0 ? void 0 : snap.id) || ((_a = event.params) === null || _a === void 0 ? void 0 : _a.docId) || "unknown";
    try {
        ...
        console.log(`[canary] saw segment pass ${docId}/${payload.cityId || "unknown"}/${payload.h3 || "unknown"}`);
    }
    catch (error) {
        ...
        try {
            ...
            console.error("segment pass canary error write failed", {
                docId,
                message: writeError === null || writeError === void 0 ? void 0 : writeError.message,
                stack: writeError === null || writeError === void 0 ? void 0 : writeError.stack,
            });
        }
    }
});
exports.iriBatchCompute = onSchedule({ schedule: "0 4 * * *", timeZone: "UTC" }, async () => {
...
exports.segmentAggBackstop = onSchedule({ schedule: "*/2 * * * *", timeZone: "UTC" }, async () => {
    const limit = 200;
    ...
    for (const doc of snapshot.docs) {
        scanned += 1;
        const data = doc.data();
        if ((data === null || data === void 0 ? void 0 : data._aggProcessed) === true) {
            skipped += 1;
            continue;
        }
        try {
...
exports.potholeAggregate = onSchedule({ schedule: "30 4 * * *", timeZone: "UTC" }, async () => {
...
exports.municipalExportCsv = onSchedule({ schedule: "0 5 * * *", timeZone: "UTC" }, async () => {
...
exports.geocodeStreets = onRequest({ region: "us-central1", cors: ["*"] }, async (req, res) => handleGeocodeStreets(req, res, { logger }));
exports.backfillSegmentAggregates = onCall(async (request) => {
    ...
    if (!adminDoc.exists || ((_b = adminDoc.data()) === null || _b === void 0 ? void 0 : _b.active) !== true) {
        throw new HttpsError("permission-denied", "Admin access required.");
    }
    const requestedLimit = typeof ((_c = request.data) === null || _c === void 0 ? void 0 : _c.limit) === "number" ? request.data.limit : null;
...
exports.backfillSegmentAggregatesForCity = wrapCallable("backfillSegmentAggregatesForCity", async (request) => {
    var _a, _b, _c, _d;
    const uid = (_a = request.auth) === null || _a === void 0 ? void 0 : _a.uid;
    if (!uid) {
        throw new HttpsError("unauthenticated", "Authentication required.");
    ...
    const cityId = typeof ((_c = request.data) === null || _c === void 0 ? void 0 : _c.cityId) === "string" ? request.data.cityId : null;
    if (!cityId) {
        throw new HttpsError("invalid-argument", "cityId is required.");
    }
    const requestedLimit = typeof ((_d = request.data) === null || _d === void 0 ? void 0 : _d.limit) === "number" ? request.data.limit : null;
    const limit = Number.isFinite(requestedLimit) && requestedLimit > 0
        ? Math.min(requestedLimit, 2000)
        : 500;
    const snapshot = await admin
    ...
    for (const doc of snapshot.docs) {
        ...
        try {
            ...
            if ((result === null || result === void 0 ? void 0 : result.skipped) && result.reason === "missing_fields") {
...
exports.aggregateOneSegmentPass = wrapCallable("aggregateOneSegmentPass", async (request) => {
    var _a, _b, _c;
    const uid = (_a = request.auth) === null || _a === void 0 ? void 0 : _a.uid;
    if (!uid) {
        throw new HttpsError("unauthenticated", "Authentication required.");
    ...
    const docId = typeof ((_c = request.data) === null || _c === void 0 ? void 0 : _c.docId) === "string" ? request.data.docId : null;
    if (!docId) {
...
exports.debugSegmentAggregationForPass = onCall(async (request) => {
    ...
    const pickFields = (data, fields) => fields.reduce((acc, key) => {
    ...
    const cityId = typeof (passData === null || passData === void 0 ? void 0 : passData.cityId) === "string" ? passData.cityId : null;
    const h3 = typeof (passData === null || passData === void 0 ? void 0 : passData.h3) === "string" ? passData.h3 : null;
    const aggregateRef = cityId && h3 ? db.doc(`municipalDaily/${cityId}/segments/${h3}`) : null;
    ...
    const payload = {
        pass: {
            ...
            _aggProcessed: (_d = passData === null || passData === void 0 ? void 0 : passData._aggProcessed) !== null && _d !== void 0 ? _d : null,
            cityId: (_e = passData === null || passData === void 0 ? void 0 : passData.cityId) !== null && _e !== void 0 ? _e : null,
            h3: (_f = passData === null || passData === void 0 ? void 0 : passData.h3) !== null && _f !== void 0 ? _f : null,
            roughnessPercent: (_g = passData === null || passData === void 0 ? void 0 : passData.roughnessPercent) !== null && _g !== void 0 ? _g : null,
            createdAt: (_h = passData === null || passData === void 0 ? void 0 : passData.createdAt) !== null && _h !== void 0 ? _h : null,
        },
        aggregate: {
            exists: (aggregateSnap === null || aggregateSnap === void 0 ? void 0 : aggregateSnap.exists) === true,
            ...((aggregateSnap === null || aggregateSnap === void 0 ? void 0 : aggregateSnap.exists)
...
if (GOOGLE_GEOCODING_API_KEY) {
    exports.roadnameEnrich = onSchedule({ schedule: "30 5 * * *", timeZone: "UTC" }, async () => {
    ...
    logger.info("roadname_enrich schedule not created because GOOGLE_GEOCODING_API_KEY is not set");
}
function computeStartDate(timeWindowValue) {
    if (timeWindowValue === "all")
        return null;
    const now = new Date();
    let msBack;
...
function normalizePothole(id, data) {
    ...
    const lat = (_c = (_b = (_a = (hasGeo ? geoPoint.latitude : null)) !== null && _a !== void 0 ? _a : (typeof data.latitude === "number" ? data.latitude : null)) !== null && _b !== void 0 ? _b : (typeof data.lat === "number" ? data.lat : null)) !== null && _c !== void 0 ? _c : (typeof data.centroidLat === "number" ? data.centroidLat : null);
    const lng = (_f = (_e = (_d = (hasGeo ? geoPoint.longitude : null)) !== null && _d !== void 0 ? _d : (typeof data.longitude === "number" ? data.longitude : null)) !== null && _e !== void 0 ? _e : (typeof data.lng === "number" ? data.lng : null)) !== null && _f !== void 0 ? _f : (typeof data.centroidLng === "number" ? data.centroidLng : null);
    ...
    const severity = typeof data.severity === "number"
        ...
        : typeof data.maxSeverity === "number"
            ? data.maxSeverity
            : null;
    const timestamp = typeof data.tsMs === "number"
        ? data.tsMs
        : typeof data.timestampMs === "number"
            ? data.timestampMs
            : ((_g = data.createdAt) === null || _g === void 0 ? void 0 : _g.toMillis)
...
exports.municipalPotholesApi = onRequest({ region: "us-central1", cors: ["*"] }, async (req, res) => {
